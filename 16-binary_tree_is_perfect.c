...
/**
 * is_leaf - Checks if a node is leaf of binary tree.
 ...
 * @tree: A pointer to node to measure depth of.
 *
 ...
 * @tree: A pointer to root node of tree to find leaf in.
 ...
 * @leaf_depth: The depth of one leaf in binary tree.
